...
// CREATE
const insertInto = 
`INSERT INTO ${table}(nombre_completo, edad, fecha_nacimiento, genero, estado_civil, correo, telefono, especialidad) 
VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *`; // RETURNING * Devuelve los datos @registrados.
...
const uptadeWhere = 
`UPDATE ${table}
SET nombre_completo = $1, edad = $2, fecha_nacimiento = $3, genero = $4, estado_civil = $5, correo = $6, telefono = $7, especialidad = $8
WHERE ${pk} = $9 RETURNING *`; // RETURNING * Devuelve los datos @actualizados.
